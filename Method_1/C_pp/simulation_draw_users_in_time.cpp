...
class Config{
    public:
        ...
        int Max_mi = 30000;
        int Seed = 0;
        float Users_per_second = 3.0; 
        float L = 2.0;
        bool Logs = false;
        // string Output_path = "graphs_from_cpp/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_150_lambda_3_0.txt";
        string Output_path = "users_in_time_output.txt";
};
...
class Network{
    ...
    Network(Config* config, BaseStation* bs1, BaseStation* bs2, BaseStation* bs3, UniformDistribution* gen_uni, bool logs ){
        this->bs_1 = bs1;
        this->bs_2 = bs2;
        this->bs_3 = bs3;
    ...
    int run(int days = 1){
        ...
        ofstream MyFile(cfg->Output_path);
        MyFile << "Seed: ";
        MyFile << cfg->Seed;
        MyFile << " UsersPerSecond: ";
        MyFile << cfg->Users_per_second;
        MyFile << "\n";
        ...
        while(time_ms < simulation_time){
            ...
            int rb_to_draw = bs_1->ResourceBlocks.size() + bs_2->ResourceBlocks.size() + bs_3->ResourceBlocks.size();
            if(rb_to_draw > peak_rb){
                peak_rb = rb_to_draw;
            }
            MyFile << time_ms;
            MyFile << " ";
...
int main(){
    ...
    for(int i = 5; i<=150; i+=15){
        ...
        {
        case 5:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_5_lambda_3_0.txt";
            break;
        case 20:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_20_lambda_3_0.txt";
            break;
        case 35:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_35_lambda_3_0.txt";
            break;
        case 50:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_50_lambda_3_0.txt";
            break;
        case 65:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_65_lambda_3_0.txt";
            break;
        case 80:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_80_lambda_3_0.txt";
            break;
        case 95:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_95_lambda_3_0.txt";
            break;
        case 110:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_110_lambda_3_0.txt";
            break;
        case 125:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_125_lambda_3_0.txt";
            break;
        case 140:
            config.Output_path = "python/cpp_output/04_06_lambda_3_0_different_seed/users_in_time_output_seed_140_lambda_3_0.txt";
            break;
        ...
        Network network_1(&config, &bs_1, &bs_2, &bs_3, &uniform_generator, config.Logs);
